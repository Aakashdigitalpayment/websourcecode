...
<div class="mp-container mp-container-medium">
  ...
  <p style="font-size:.78rem;color:#64748b;line-height:1.5;margin:0 0 16px;padding:10px 12px;background:#f8fafc;border-radius:10px;border:1px solid #e2e8f0;">
    <?php if ($hasInstantProgram): ?>
      <?php echo $_t('<strong>Instant QR</strong> कार्यक्रममा scan/check-in गर्दा तत्काल उपस्थिति दर्ता हुन्छ। <strong>अन्य कार्यक्रम</strong>मा Admin approve पछि मात्र इतिहासमा देखिन्छ। Staff ले <strong>Registration Desk</strong> बाट कार्डको Member ID राखेर तत्काल दर्ता गर्न सक्छ। <strong>Pre-register</strong> = अगाडि नाम दर्ता मात्र।', '<strong>Instant QR</strong> programs record attendance immediately on scan/check-in. <strong>Other programs</strong> appear in history only after admin approval. Staff can record instantly via <strong>Registration Desk</strong> using Member ID on card. <strong>Pre-register</strong> only reserves your name.'); ?>
    <?php else: ?>
      <?php echo $_t('<strong>QR / Check-in</strong> स्थलमा गरेपछि Admin स्वीकृतिका लागि अनुरोध जान्छ; approve पछि मात्र उपस्थिति इतिहासमा देखिन्छ। Staff ले Registration Desk बाट कार्डको Member ID राखेर तत्काल पनि राख्न सक्छ। <strong>Pre-register</strong> = अगाडि नाम दर्ता मात्र (गणना बढाउँदैन)।', '<strong>QR / Check-in</strong> sends a request for admin approval; it appears in attendance history only after approve. Staff can mark instantly at Registration Desk with Member ID on card. <strong>Pre-register</strong> only reserves your name (does not count as attendance).'); ?>
    <?php endif; ?>
  </p>
