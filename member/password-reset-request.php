...
<div class="card">
  ...
  <div class="card-body p-4">
    ...
    <div class="step-bar">
      ...
      <?php echo $step==1
        ? '<i class="lucide-icon me-1" aria-hidden="true" data-lucide="search"></i>' . $_t('चरण १: खाता पहिचान', 'Step 1: Identify account')
        : ($step==2
          ? '<i class="lucide-icon me-1" aria-hidden="true" data-lucide="key-round"></i>' . $_t('चरण २: OTP Verify', 'Step 2: OTP Verify')
          : '<i class="lucide-icon me-1" aria-hidden="true" data-lucide="lock"></i>' . $_t('चरण ३: नयाँ पासवर्ड', 'Step 3: New Password')); ?>
    </p>
    <?php endif; ?>
    ...
    <div class="text-center py-4">
      ...
      <a href="login.php" class="btn btn-g px-4 py-2 fw-semibold mt-2">
        <i class="lucide-icon me-2" aria-hidden="true" data-lucide="log-in"></i><?php echo $_t('Login गर्नुहोस्', 'Login'); ?>
      </a>
    </div>
    <?php endif; ?>
    ...
    <div class="text-center mt-4 pt-3 border-top">
      <a href="login.php" class="text-success text-decoration-none small">
        <i class="lucide-icon me-1" aria-hidden="true" data-lucide="arrow-left"></i><?php echo $_t('Login पेजमा फर्कनुहोस्', 'Back to login page'); ?>
      </a>
    </div>
    <?php endif; ?>
