...
/* KYC-linked profile priority (SSOT: kyc_application_id → sadasyata; no email/mobile soft match) */
$kycRow = null;
try {
...
$quickActions = [
    ...
    ['href' => $siteUrl.'member/marketplace.php',               'icon' => 'fa-store',               'color' => 'var(--primary-color)', 'label' => $_t('बजार / सीप', 'Market / Skills')],
