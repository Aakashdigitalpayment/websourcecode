...
if (!function_exists('site_license_public_guard')) {
    ...
    function site_license_public_guard(): void {
        ...
        $layoutCss = '';
        if (function_exists('coopThemeLinkHtml')) {
            $layoutCss = coopThemeLinkHtml('assets/css/site-license-expired-page.css');
        } else {
            $layoutCss = '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/site-license-expired-page.css">' . "\n";
        }
        ...
        echo '<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . (function_exists('coopThemeGoogleFontsHtml') ? coopThemeGoogleFontsHtml() : '')
            . '<link rel="stylesheet" href="' . $baseUrlH . 'assets/css/global.css">'
            . $brandDynamicStyle
            . $layoutCss
