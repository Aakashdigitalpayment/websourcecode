                ...
                <ul class="nav-menu">
                    ...
                    <li class="has-dropdown <?php echo in_array($currentPage, ['news', 'career', 'reports', 'downloads', 'service-centers', 'faqs', 'member-survey', 'partner-facilities', 'application-tracker', 'sahakari-patro', 'member-marketplace', 'member-skills'], true) ? 'active' : ''; ?>">
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a href="<?php echo SITE_URL; ?>partner-facilities.php"><i class="fas fa-handshake"></i> <?php echo isEnglish() ? 'Partner Facilities' : 'साझेदार सुविधा'; ?></a></li>
                            <li><a href="<?php echo SITE_URL; ?>application-tracker.php"><i class="fas fa-magnifying-glass"></i> <?php echo isEnglish() ? 'Track Application' : 'आवेदन ट्र्याक'; ?></a></li>
                            <li><a href="<?php echo SITE_URL; ?>sahakari-patro.php"><i class="fas fa-calendar-days"></i> <?php echo isEnglish() ? 'Sahakari Patro' : 'सहकारी पात्रो'; ?></a></li>
