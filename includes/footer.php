...
?>
    ...
    $__skipDatepickerPages = [
        ...
        'chairman-message.php', 'ceo-message.php', 'success-stories.php', 'vision-mission.php', 'why-choose.php',
    ...
    $__needsFormValidation = !in_array($__scriptName, $__skipFormValidationPages, true)
...
<div class="qh-launcher" id="qhLauncher" aria-label="Quick Actions">
  <div class="qh-menu" role="menu">
    ...
    <button type="button" class="qh-item" role="menuitem"
      ...
      <span class="qh-ic help"><i class="lucide-icon" aria-hidden="true" data-lucide="help-circle"></i></span>
