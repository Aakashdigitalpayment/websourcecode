...
assertFileContains('includes/header.php', 'property="og:image:width"', 'og:image width for social crop');
assertFileContains('includes/header.php', 'seo_default_share_image', 'header uses landscape share image helper');
assertFileContains('includes/config.php', 'function seo_default_share_image', 'share image helper exists');
assertFileContains('share-og.php', '1200', 'landscape OG card generator present');
assertFileContains('includes/public-member-access.php', 'function coopMemberAccessIsSocialLinkCrawler', 'social crawlers bounce to HTML for OG');
assertFileContains('reports.php', 'Enrich Open Graph title', 'shared report id enriches OG title');
