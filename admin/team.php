                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="small tm-meta-muted mt-1">
                                <?php if ($teamListSection === 'karmachari'): ?>
                                    <?php echo $__t('यहाँ ', 'Here only '); ?><strong><?php echo $__t('कर्मचारी', 'staff'); ?></strong><?php echo $__t(' श्रेणीका पद मात्र देखिन्छन्। नयाँ पद ', ' category designations are shown. Add new designation from '); ?><a href="designations.php" target="_blank" rel="noopener noreferrer"><?php echo $__t('पद मास्टर', 'Designation Master'); ?></a><?php echo $__t(' मा ', ' with '); ?><em><?php echo $__t('श्रेणी: कर्मचारी', 'category: staff'); ?></em><?php echo $__t(' राखेर थप्नुहोस्।', '.'); ?>
                                <?php else: ?>
                                    <?php echo $__t('यहाँ ', 'Here only '); ?><strong><?php echo $__t('समिति', 'committee'); ?></strong><?php echo $__t(' श्रेणीका पद मात्र देखिन्छन्। नयाँ पद ', ' category designations are shown. Add new designation from '); ?><a href="designations.php" target="_blank" rel="noopener noreferrer"><?php echo $__t('पद मास्टर', 'Designation Master'); ?></a><?php echo $__t(' मा ', ' with '); ?><em><?php echo $__t('श्रेणी: समिति', 'category: committee'); ?></em><?php echo $__t(' राखेर थप्नुहोस्।', '.'); ?>
                                <?php endif; ?>
                            </div>
                        </div>
