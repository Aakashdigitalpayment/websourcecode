...
if (!function_exists('fa_to_lucide_map')) {
    function fa_to_lucide_map(): array {
        static $map = [
            ...
            'fa-check-to-slot'           => 'vote',
            'fa-basket-shopping'         => 'shopping-basket',
            'fa-th-list'                 => 'list',
            'fa-user-clock'                => 'user-round-clock',
            'fa-robot'                     => 'bot',
            'fa-stop-circle'               => 'circle-stop',
            'fa-magnifying-glass-chart'    => 'chart-no-axes-combined',
            ...
            'fa-mars'         => 'user',
            'fa-venus'        => 'user-round',
            'fa-calendar-days'=> 'calendar-range',
            'fa-circle-minus' => 'minus-circle',
            'fa-hourglass-half' => 'hourglass',
            'fa-hourglass'    => 'hourglass',
            'fa-list'         => 'list',
            'fa-vial-circle-check' => 'flask-conical',
            'fa-compass'      => 'compass',
